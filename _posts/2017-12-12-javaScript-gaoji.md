---
layout: post
title:  "javaScript高级概论"
date:   2017-12-12
excerpt: "面向对象的开发思想及模式，JavaScript中正则表达式的使用"
javascript: true
tag:
- markdown 
- javascript
...
<img src="{{ site.url }}/assets/img/media/Unofficial_JavaScript_logo_2.svg.png" width="400" alt="">
...
![课程大纲]({{ site.url }}/assets/img//media/课程大纲.png)
...
<img src="{{ site.url }}/assets/img/media/mxdxkf.png" width="400" alt="">
...
<img src="{{ site.url }}/assets/img/media/20160823024542444.jpg" alt="">
...
> 面向对象：它只是过程式代码的一种高度封装，目的在于提高代码的开发效率和可维护性。

<img src="{{ site.url }}/assets/img/media/664ba37eeee9f4623c06c066867f1d38_r.jpg" width="400" alt="">
...
我们可以写一个函数，解决代码重复问题：*代码太过冗余，重复性太高*
...
以这种方式调用构造函数会经历以下 4 个步骤：new:做了几件事？
...
自我总结：单独创建一个对象，工厂模式，构造函数  创建对象三者之间的区别及优缺点：
...
<img src="{{ site.url }}/assets/img/media/构造函数-实例-原型之间的关系.png" alt="">
...
- `type of`和`instanceof`:instanceof需要前后两个操作数

  ```
  //实际上typeof在检测数据类型时，如果数据为一个指针，会认为是object
  //2 其他常用的类型检测方式：
  	// - Array.isArray() ie9以下不支持
  		 console.log(Array.isArray([1,2,3]));//如果是数组返回true
  	// - instanceof 需要前后两个操作数
  	//	 前操作数为实例对象，后操作数为构造函数
  	//	 如果实例对象是通过构造函数创建的，返回true，否则返回false
  		 console.log([1,2,3] instanceof Array);
  		 console.log(200 instanceof Array);
  	// - Object.prototype.toString.call([1,2,3])//['object Array']
  	//   返回的结果为数据类型名:(固定用法，记住即可)
  	总结：检测实例对象和构造函数之间的关系：instanceof
  ```
...
自调用函数的作用：
			...
			// 2 减少作用域的访问次数
			//   通过传参的方式设置常用的值 window,document undefined
			//undefined - 是一个预定义的全局变量
### 案例：随机方块
